...
export const About = () => {
  return (
    <div className="   z-40 h-screen w-screen text-white flex justify-center align-middle items-center m-auto">
      <div className="    rounded-3xl bg-gradient-to-r from-[#00d1fb]   via-[#e402b3]  via-35% to-[#000000]  shadow-2xl shadow-white/30 w-[70%]  flex flex-col justify-center align-middle items-center p-[.1%]">
